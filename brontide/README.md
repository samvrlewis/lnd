...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/samvrlewis/lnd/brontide)
...
detail in [BOLT #8 of the Lightning Network specifications](https://github.com/samvrlewis/lightning-rfc/blob/master/08-transport.md).
...
```bash
$ go get -u github.com/samvrlewis/lnd/brontide
```
