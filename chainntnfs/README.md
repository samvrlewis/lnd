...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/samvrlewis/lnd/chainntnfs)
...
```bash
$ go get -u github.com/samvrlewis/lnd/chainntnfs
```
